...
**영상 기하학이란?** 쉽게 말해 3차원 공간의 물체가 카메라를 통해 2차원 영상에 어떻게 투영되는지를 기하학적으로 다루는 것입니다. 다양한 비전 분야에서 가장 기본이 되는 요소입니다.

영상 기하학에서 4개의 좌표계로 분류합니다.
...
> **Note: 이미지 센서 평면 좌표계**
> 
> <small> 보통 위와 같이 4개로 나누는게 일반적이지만 이미지 센서 상에 맺히는 기하학적 2D 위치 좌표계를 추가합니다.
